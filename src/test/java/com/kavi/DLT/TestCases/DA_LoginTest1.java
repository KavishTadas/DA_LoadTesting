...
public class DA_LoginTest1 extends BaseClass {
	...
	public void LoginTest1() throws Exception {
		...
		try {
			...
			if (novaPage.getBotMessageTextWithText(RC.readOpenMsg())) {
				novaPage.TextBox();
				novaPage.Search("OMI-0086");
				ExtentTest.info("User Name : " + "OMI-0086");
				novaPage.Send();
			} else {
			...
			if (novaPage.HiUser().contains("Hi Mallikarjun") && novaPage.WelcomeMsg().contains(RC.readWelcomeMsg())) {
